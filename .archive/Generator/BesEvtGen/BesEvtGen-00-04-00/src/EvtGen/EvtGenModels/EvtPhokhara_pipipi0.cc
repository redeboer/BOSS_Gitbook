...
int EvtPhokhara_pipipi0::nevtgen=0;
int EvtPhokhara_pipipi0::nphokharadecays=0;
EvtDecayBasePtr* EvtPhokhara_pipipi0::phokharadecays=0; 
int EvtPhokhara_pipipi0::ntable=0;

int EvtPhokhara_pipipi0::ncommand=0;
int EvtPhokhara_pipipi0::lcommand=0;
std::string* EvtPhokhara_pipipi0::commands=0;
int EvtPhokhara_pipipi0::nevt=0;

EvtPhokhara_pipipi0::EvtPhokhara_pipipi0(){}
EvtPhokhara_pipipi0::~EvtPhokhara_pipipi0(){
  int i;
...
void EvtPhokhara_pipipi0::getName(std::string& model_name){

  model_name="PHOKHARA_pipipi0";     

}

EvtDecayBase* EvtPhokhara_pipipi0::clone(){

  return new EvtPhokhara_pipipi0;

}


void EvtPhokhara_pipipi0::initProbMax(){
...
void EvtPhokhara_pipipi0::init_mode(EvtParticle* p){
 m_pion=8; 
...
std::string EvtPhokhara_pipipi0::commandName(){
     
  return std::string("PhokharaPar");
  
}

void EvtPhokhara_pipipi0::command(std::string cmd){
...
void EvtPhokhara_pipipi0::decay( EvtParticle *p){
 ...
 std::cout<<"PHOKHARA : pi+pi-pi0 mode "<<std::endl;
...
void EvtPhokhara_pipipi0::store(EvtDecayBase* jsdecay){
...
void EvtPhokhara_pipipi0::PhokharaInit(int dummy){
  static int first=1;
  if (first){
...
void EvtPhokhara_pipipi0::init_evt(EvtParticle* p){
 m_pion=8; 
 // mu+mu-(0),pi+pi-(1),2pi0pi+pi-(2),
 // 2pi+2pi-(3),ppbar(4),nnbar(5),
 // K+K-(6),K0K0bar(7),pi+pi-pi0(8), 
