...
class EvtMTree {
    ...
    public:
        ...
        EvtSpinAmp amplitude( const vector<EvtVector4R>&
                product) const;
    ...
    private:
        ...
        bool parsecheck( char arg, const string& chars );
        ...
        EvtMRes * makeresonance( const EvtId&, const string &,
                const vector<string>&, const string& , 
                const vector<EvtComplex>& , const vector<EvtMNode * >& ); 
