#ifndef Physics_Analysis_DzeroPhiRootNamespace_H
#define Physics_Analysis_DzeroPhiRootNamespace_H
...
namespace AnaBranches
{
	 ...
	 */
	namespace fit4c {
		double mD0;   //!< Invariant mass \f$ M_{K^-pi^+} \f$ (\f$ D^0    \f$)
		double mphi;  //!< Invariant mass \f$ M_{K^+K^+ } \f$ (\f$ \phi   \f$)
		double mJpsi; //!< Invariant mass \f$ M_{D^0phi } \f$ (\f$ J/\psi \f$)
