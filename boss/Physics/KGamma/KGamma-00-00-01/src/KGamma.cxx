...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
// CONSTRUCTOR: // TODO: check what declareProperty does
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
// INITIALIZE: Loads all m_tuples from the dst file (FILE1)
StatusCode Rhopi::initialize(){
  ...
  // * ------- Import ToF inner barrel branch ------- *
  if(m_checkTof == 1) {
  ...
  // * ------- Import ToF outer barrel branch ------- *
  if(m_checkTof == 1) {
  ...
  } // check ToF: barrel outer ToF

  // * ------- Import particle ID branch ------- *
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
// EXECUTE: Apply cuts event-by-event
StatusCode Rhopi::execute() {
  ...
  SmartDataPtr<EvtRecTrackCol> evtRecTrkCol(eventSvc(), EventModel::EvtRec::EvtRecTrackCol); // collection of ALL events
...
// * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
// FINALIZE: only returns output messages
