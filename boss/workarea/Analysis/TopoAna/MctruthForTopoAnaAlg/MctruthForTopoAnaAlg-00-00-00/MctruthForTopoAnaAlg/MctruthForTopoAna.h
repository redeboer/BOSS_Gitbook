...
/// @{
	 ...
	 * @details It is essential to run load this algorithm along with your own algorithm if you want to run `topoana.exe` over the output of your initial event selection. This algorithm (`MctruthForTopoAna`) will store the relevant 'Monte Carlo truth' information.
