...
\hline
index & event branch of $ B^{0} $ & iEvtBrOfP1 & nEtrs & nCmltEtrs \\
\hline
...
\hline
rest & $ B^{0} \rightarrow \rm{others} $ & --- & 146 & 196 \\
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|c|c|c|c|c|}
\hline
index & event branch of $ \bar{B}^{0} $ & iEvtBrOfP2 & nEtrs & nCmltEtrs \\
\hline
...
\hline
rest & $ \bar{B}^{0} \rightarrow \rm{others} $ & --- & 146 & 204 \\
\hline
\end{tabular}
\end{table}
\end{document}
