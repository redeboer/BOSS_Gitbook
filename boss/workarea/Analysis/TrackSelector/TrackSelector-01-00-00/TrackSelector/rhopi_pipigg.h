...
protected:
	...
	// * Maps of Ntuples *
		...
		bool fDo_fit5c_all;  //!< Package property that determines whether or not to write results of the `5C` fit <i>for all combinations</i>.
		bool fDo_fit5c_best; //!< Package property that determines whether or not to write results of the `5C` fit for the combination closest to the expected masses.
	...
	// * Cut parameters * //
		...
		double fCut_MaxGammaPhi;   //!< Maximum \f$\phi\f$ angle between the photon and the nearest charged track <i>in radians</i>.
		double fCut_MaxGammaTheta; //!< Maximum \f$\theta\f$ angle between the photon and the nearest charged track <i>in radians</i>.
		double fCut_MaxGammaAngle; //!< Maximum angle between the photon and the nearest charged track <i>in degrees</i>.
