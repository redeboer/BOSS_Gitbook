...
// * =========================== * //
	...
	NTupleTopoAna::NTupleTopoAna(const std::string &name, const std::string &description) :
	...
	NTupleTopoAna::~NTupleTopoAna()
	{
		instances.erase(Name());
	}

	std::map<std::string, NTupleTopoAna*> NTupleTopoAna::instances;
...
// * =============================== * //
	...
	void NTupleTopoAna::Write() const
	{
...
// * ================================== * //
	...
	void NTupleTopoAna::AddItem(const std::string &item_name)
	{
		/// <ol>
