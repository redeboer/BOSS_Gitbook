...
/// @{
	...
	/**
	 * @brief    Modified header of the stock BOSS package `PipiJpsi` (version `00-00-03`).
	...
	// ! ================================= ! //
		/// @name Cut parameters
		/// @details Here, you can define data members that you use to define cuts. The values for these cuts should be set in the `PipiJpsi::PipiJpsi` constructor (see `.cxx` file)
			///@{
