#ifndef Physics_Analysis_KKGamma_H
#define Physics_Analysis_KKGamma_H
...
// * ------- CLASS DEFINITION ------- * //
// * ================================ * //
class KKGamma : public Algorithm
{
public:
	// * Constructor and destructors *
	KKGamma(const std::string& name, ISvcLocator* pSvcLocator);
...
private:
	...
	// ! ------- DECLARE CUTS HERE ------- ! //
		// Here, you can define data members that you use to define cuts. The values for these cuts should be set in the `KKGamma::KKGamma` constructor (see `.cxx` file).
	...
	// ! ------- DECLARE NTUPLES HERE ------- ! //
		...
		// Note that the NTuple::Items are added to the NTuple during the KKGamma::initialize() step. This is also the place where you name these variables, so make sure that the structure here is reflected there!
