...
// * =========================== * //
/**
 * @brief Constructor for the `KKGamma` algorithm.
 * @details Here, you should declare properties: give them a name, assign a parameter (data member of `KKGamma`), and if required a documentation string. Note that you should define the paramters themselves in the header (KKGamma/KKGamma.h) and that you should assign the values in `share/jopOptions_KKGamma.txt`.
 */
...
KKGamma::KKGamma(const std::string& name, ISvcLocator* pSvcLocator) :
