 ...
 * Package: EvtGenBase
 *    File: $Id: EvtTwoBodyVertex.cc,v 1.3 2011/01/06 22:57:56 pingrg Exp $
...
double EvtTwoBodyVertex::widthFactor(EvtTwoBodyKine x) const
{
  ...
  double factor = pow(p1/_p0,2*_LL+1)*pow(mAB()/x.mAB(),2) * ff * ff;  //pingrg,2008-11-24, in EvtGen Manual Eq 66, (m0/m) should be squared 
