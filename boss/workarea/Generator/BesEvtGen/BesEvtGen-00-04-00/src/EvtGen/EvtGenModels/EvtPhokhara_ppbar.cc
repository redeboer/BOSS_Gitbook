...
int EvtPhokhara_ppbar::nevtgen=0;
int EvtPhokhara_ppbar::nphokharadecays=0;
EvtDecayBasePtr* EvtPhokhara_ppbar::phokharadecays=0; 
int EvtPhokhara_ppbar::ntable=0;

int EvtPhokhara_ppbar::ncommand=0;
int EvtPhokhara_ppbar::lcommand=0;
std::string* EvtPhokhara_ppbar::commands=0;
int EvtPhokhara_ppbar::nevt=0;

EvtPhokhara_ppbar::EvtPhokhara_ppbar(){}
EvtPhokhara_ppbar::~EvtPhokhara_ppbar(){
  int i;
...
void EvtPhokhara_ppbar::getName(std::string& model_name){

  model_name="PHOKHARA_ppbar";     

}

EvtDecayBase* EvtPhokhara_ppbar::clone(){

  return new EvtPhokhara_ppbar;

}


void EvtPhokhara_ppbar::initProbMax(){
...
void EvtPhokhara_ppbar::init_mode(EvtParticle* p){
 m_pion=4; 
...
std::string EvtPhokhara_ppbar::commandName(){
     
  return std::string("PhokharaPar");
  
}

void EvtPhokhara_ppbar::command(std::string cmd){
...
void EvtPhokhara_ppbar::decay( EvtParticle *p){
 ...
 std::cout<<"PHOKHARA :  ppbar  mode "<<std::endl;
...
void EvtPhokhara_ppbar::store(EvtDecayBase* jsdecay){
...
void EvtPhokhara_ppbar::PhokharaInit(int dummy){
  static int first=1;
  if (first){
...
void EvtPhokhara_ppbar::init_evt(EvtParticle* p){
 m_pion=4; 
 // mu+mu-(0),pi+pi-(1),2pi0pi+pi-(2),
 // 2pi+2pi-(3),ppbar(4),nnbar(5),
 // K+K-(6),K0K0bar(7),pi+pi-pi0(8), 
