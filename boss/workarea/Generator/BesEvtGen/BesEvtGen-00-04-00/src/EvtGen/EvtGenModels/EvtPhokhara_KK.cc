...
int EvtPhokhara_KK::nevtgen=0;
int EvtPhokhara_KK::nphokharadecays=0;
EvtDecayBasePtr* EvtPhokhara_KK::phokharadecays=0; 
int EvtPhokhara_KK::ntable=0;

int EvtPhokhara_KK::ncommand=0;
int EvtPhokhara_KK::lcommand=0;
std::string* EvtPhokhara_KK::commands=0;
int EvtPhokhara_KK::nevt=0;

EvtPhokhara_KK::EvtPhokhara_KK(){}
EvtPhokhara_KK::~EvtPhokhara_KK(){
  int i;
...
void EvtPhokhara_KK::getName(std::string& model_name){

  model_name="PHOKHARA_KK";     

}

EvtDecayBase* EvtPhokhara_KK::clone(){

  return new EvtPhokhara_KK;

}


void EvtPhokhara_KK::initProbMax(){
...
void EvtPhokhara_KK::init_mode(EvtParticle* p){
 m_pion=6; 
...
std::string EvtPhokhara_KK::commandName(){
     
  return std::string("PhokharaPar");
  
}

void EvtPhokhara_KK::command(std::string cmd){
...
void EvtPhokhara_KK::decay( EvtParticle *p){
 ...
 std::cout<<"PHOKHARA :  K+K-  mode "<<std::endl;
...
void EvtPhokhara_KK::store(EvtDecayBase* jsdecay){
...
void EvtPhokhara_KK::PhokharaInit(int dummy){
  static int first=1;
  if (first){
...
void EvtPhokhara_KK::init_evt(EvtParticle* p){
 m_pion=6; 
 // mu+mu-(0),pi+pi-(1),2pi0pi+pi-(2),
 // 2pi+2pi-(3),ppbar(4),nnbar(5),
 // K+K-(6),K0K0bar(7),pi+pi-pi0(8), 
