...
int EvtPhokhara_LLB::nevtgen=0;
int EvtPhokhara_LLB::nphokharadecays=0;
EvtDecayBasePtr* EvtPhokhara_LLB::phokharadecays=0; 
int EvtPhokhara_LLB::ntable=0;

int EvtPhokhara_LLB::ncommand=0;
int EvtPhokhara_LLB::lcommand=0;
std::string* EvtPhokhara_LLB::commands=0;
int EvtPhokhara_LLB::nevt=0;
...
void EvtPhokhara_LLB::getName(std::string& model_name){

  model_name="PHOKHARA_LLB";     

}

EvtDecayBase* EvtPhokhara_LLB::clone(){

  return new EvtPhokhara_LLB;
...
void EvtPhokhara_LLB::decay( EvtParticle *p){
 ...
 std::cout<<"PHOKHARA :  Lambda anti-Lambda  mode "<<std::endl;
...
void EvtPhokhara_LLB::store(EvtDecayBase* jsdecay){
