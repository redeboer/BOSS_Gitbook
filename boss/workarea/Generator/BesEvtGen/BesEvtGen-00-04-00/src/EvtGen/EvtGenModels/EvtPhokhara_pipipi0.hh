...
#ifndef EVTPHOKHARAPIPIPI0_HH
#define EVTPHOKHARAPIPIPI0_HH
...
class EvtPhokhara_pipipi0:public  EvtDecayIncoherent  {

public:

  EvtPhokhara_pipipi0();
  virtual ~EvtPhokhara_pipipi0();
