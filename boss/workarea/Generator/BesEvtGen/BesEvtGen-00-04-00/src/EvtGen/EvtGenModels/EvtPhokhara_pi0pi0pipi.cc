...
int EvtPhokhara_pi0pi0pipi::nevtgen=0;
int EvtPhokhara_pi0pi0pipi::nphokharadecays=0;
EvtDecayBasePtr* EvtPhokhara_pi0pi0pipi::phokharadecays=0; 
int EvtPhokhara_pi0pi0pipi::ntable=0;

int EvtPhokhara_pi0pi0pipi::ncommand=0;
int EvtPhokhara_pi0pi0pipi::lcommand=0;
std::string* EvtPhokhara_pi0pi0pipi::commands=0;
int EvtPhokhara_pi0pi0pipi::nevt=0;
...
void EvtPhokhara_pi0pi0pipi::getName(std::string& model_name){

  model_name="PHOKHARA_pi0pi0pipi";     

}

EvtDecayBase* EvtPhokhara_pi0pi0pipi::clone(){

  return new EvtPhokhara_pi0pi0pipi;
...
void EvtPhokhara_pi0pi0pipi::decay( EvtParticle *p){
 ...
 std::cout<<"PHOKHARA :  pi0pi0pi+pi-  mode "<<std::endl;
...
void EvtPhokhara_pi0pi0pipi::store(EvtDecayBase* jsdecay){
