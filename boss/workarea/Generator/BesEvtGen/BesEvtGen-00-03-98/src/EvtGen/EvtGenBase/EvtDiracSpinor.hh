...
EvtTensor4C  EvtLeptonTg5Current(const EvtDiracSpinor& d,const EvtDiracSpinor& dp);// u-bar sigma^{mu,nu} gamma_5 v,pingrg
...
class EvtDiracSpinor {
  ...
  friend EvtTensor4C  EvtLeptonTCurrent 
	(const EvtDiracSpinor& d,const EvtDiracSpinor& dp);
  friend EvtTensor4C  EvtLeptonTg5Current 
	(const EvtDiracSpinor& d,const EvtDiracSpinor& dp);
