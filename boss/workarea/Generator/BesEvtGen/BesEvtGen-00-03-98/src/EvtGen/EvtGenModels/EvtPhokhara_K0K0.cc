...
int EvtPhokhara_K0K0::nevtgen=0;
int EvtPhokhara_K0K0::nphokharadecays=0;
EvtDecayBasePtr* EvtPhokhara_K0K0::phokharadecays=0; 
int EvtPhokhara_K0K0::ntable=0;

int EvtPhokhara_K0K0::ncommand=0;
int EvtPhokhara_K0K0::lcommand=0;
std::string* EvtPhokhara_K0K0::commands=0;
int EvtPhokhara_K0K0::nevt=0;

EvtPhokhara_K0K0::EvtPhokhara_K0K0(){}
EvtPhokhara_K0K0::~EvtPhokhara_K0K0(){
  int i;
...
void EvtPhokhara_K0K0::getName(std::string& model_name){

  model_name="PHOKHARA_K0K0";     

}

EvtDecayBase* EvtPhokhara_K0K0::clone(){

  return new EvtPhokhara_K0K0;

}


void EvtPhokhara_K0K0::initProbMax(){
...
void EvtPhokhara_K0K0::init_mode(EvtParticle* p){
 m_pion=7; 
...
std::string EvtPhokhara_K0K0::commandName(){
     
  return std::string("PhokharaPar");
  
}

void EvtPhokhara_K0K0::command(std::string cmd){
...
void EvtPhokhara_K0K0::decay( EvtParticle *p){
  ...
  std::cout<<"PHOKHARA : K0K0bar  mode "<<std::endl;
...
void EvtPhokhara_K0K0::store(EvtDecayBase* jsdecay){
...
void EvtPhokhara_K0K0::PhokharaInit(int dummy){
  static int first=1;
  if (first){
...
void EvtPhokhara_K0K0::init_evt(EvtParticle* p){
 m_pion=7; 
 // mu+mu-(0),pi+pi-(1),2pi0pi+pi-(2),
 // 2pi+2pi-(3),ppbar(4),nnbar(5),
 // K+K-(6),K0K0bar(7),pi+pi-pi0(8), 
