...
int EvtPhokhara_nnbar::nevtgen=0;
int EvtPhokhara_nnbar::nphokharadecays=0;
EvtDecayBasePtr* EvtPhokhara_nnbar::phokharadecays=0; 
int EvtPhokhara_nnbar::ntable=0;

int EvtPhokhara_nnbar::ncommand=0;
int EvtPhokhara_nnbar::lcommand=0;
std::string* EvtPhokhara_nnbar::commands=0;
int EvtPhokhara_nnbar::nevt=0;
...
void EvtPhokhara_nnbar::getName(std::string& model_name){

  model_name="PHOKHARA_nnbar";     

}

EvtDecayBase* EvtPhokhara_nnbar::clone(){

  return new EvtPhokhara_nnbar;

}


void EvtPhokhara_nnbar::initProbMax(){
...
std::string EvtPhokhara_nnbar::commandName(){
     
  return std::string("PhokharaPar");
  
}

void EvtPhokhara_nnbar::command(std::string cmd){
...
void EvtPhokhara_nnbar::decay( EvtParticle *p){
 ...
 std::cout<<"PHOKHARA :  nnbar  mode "<<std::endl;
...
void EvtPhokhara_nnbar::store(EvtDecayBase* jsdecay){
