...
int EvtPhokhara_pipieta::nevtgen=0;
int EvtPhokhara_pipieta::nphokharadecays=0;
EvtDecayBasePtr* EvtPhokhara_pipieta::phokharadecays=0; 
int EvtPhokhara_pipieta::ntable=0;

int EvtPhokhara_pipieta::ncommand=0;
int EvtPhokhara_pipieta::lcommand=0;
std::string* EvtPhokhara_pipieta::commands=0;
int EvtPhokhara_pipieta::nevt=0;
...
void EvtPhokhara_pipieta::getName(std::string& model_name){

  model_name="PHOKHARA_pipieta";     

}

EvtDecayBase* EvtPhokhara_pipieta::clone(){

  return new EvtPhokhara_pipieta;
...
void EvtPhokhara_pipieta::decay( EvtParticle *p){
 ...
 std::cout<<"PHOKHARA : pi+pi-eta mode "<<std::endl;
 ...
 storedEvents:
  ...
  if (flags_.pion == 9) { //Lambda Lambdabar-> pi+ pi- ppbar
   ...
   // pi-
    ...
    numstable++;
    // eta
    evtnumstable[numstable]=EvtPDL::evtIdFromStdHep(221);
    p4[numstable].set(ctes_.momenta[0][7],ctes_.momenta[1][7], ctes_.momenta[2][7], ctes_.momenta[3][7]);
    numstable++;
  }
...
void EvtPhokhara_pipieta::store(EvtDecayBase* jsdecay){
