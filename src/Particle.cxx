...
// * =============================== * //
	...
	TString& Particle::DetermineNameLaTeX()
	{
		if(!fParticlePDG) fParticleNameLaTeX = "";
			...
			// * Gauge boson
				case 21: fParticleNameLaTeX = "#text{g}";       break; // graviton
				case 22: fParticleNameLaTeX = "#gamma";           break; // photon
				case 23: fParticleNameLaTeX = "#text{Z}^{0}";   break; // Z boson
				case 24: fParticleNameLaTeX = "#text{W}^{+}";   break; // W boson
				case -24:fParticleNameLaTeX = "#text{W}^{-}";   break; // W boson
				case 25: fParticleNameLaTeX = "#text{h}^{0}";   break; // Higgs boson
				case 32: fParticleNameLaTeX = "#text{Z}'^{0}";  break; // Z prime boson
				case 33: fParticleNameLaTeX = "#text{Z}''^{0}"; break; // Z double prime boson
				case 34: fParticleNameLaTeX = "#text{W}'^{+}";  break; // W prime boson
				case -34:fParticleNameLaTeX = "#text{W}'^{-}";  break; // W prime boson
				case 35: fParticleNameLaTeX = "#text{H}^{0}";   break; // H0 boson
				case 36: fParticleNameLaTeX = "#text{A}^{0}";   break; // neutral A boson
				case 37: fParticleNameLaTeX = "#text{H}^{+}";   break; // H+ boson
				case -37:fParticleNameLaTeX = "#text{H}^{-}";   break; // H+ boson
				case 39: fParticleNameLaTeX = "#text{G}";       break; // graviton
				case 41: fParticleNameLaTeX = "#text{R}^{0}";   break; // neutral R boson
				case 42: fParticleNameLaTeX = "#text{L}_{#text{Q}}"; break; // LQ boson
			// * Mesons
				...
				case 311: fParticleNameLaTeX = "#text{K}^{0}";               break; // neutral K meson
				case 313: fParticleNameLaTeX = "#text{K}^{*0}";              break; // neutral K* meson
				case 321: fParticleNameLaTeX = "#text{K}^{+}";               break; // positive kaon
				case -321:fParticleNameLaTeX = "#text{K}^{-}";               break; // negative kaon
				case 323: fParticleNameLaTeX = "#text{K}^{*+}";              break; // positive K* meson
				case -323:fParticleNameLaTeX = "#text{K}^{*-}";              break; // negative K* meson
				case 411: fParticleNameLaTeX = "#text{D}^{+}";               break; // positive D meson
				case -411:fParticleNameLaTeX = "#text{D}^{-}";               break; // negative D meson
				case 413: fParticleNameLaTeX = "#text{D}^{*+}";              break; // positive D* meson
				case -413:fParticleNameLaTeX = "#text{D}^{*-}";              break; // negative D* meson
				case 421: fParticleNameLaTeX = "#text{D}^{0}";               break; // neutral D meson
				case 423: fParticleNameLaTeX = "#text{D}^{*0}";              break; // neutral D* meson
				case 431: fParticleNameLaTeX = "#text{D}_{#text{s}}^{+}";  break; // positive D strange meson
				case -431:fParticleNameLaTeX = "#text{D}_{#text{s}}^{-}";  break; // positive D strange meson
				case 433: fParticleNameLaTeX = "#text{D}_{#text{s}}^{*+}"; break; // positive D* strange meson
				case -433:fParticleNameLaTeX = "#text{D}_{#text{s}}^{*-}"; break; // negative D* strange meson
				case 511: fParticleNameLaTeX = "#text{B}^{0}";               break; // neutral B meson
				case 513: fParticleNameLaTeX = "#text{B}^{*0}";              break; // neutral B* meson
				case 521: fParticleNameLaTeX = "#text{B}^{+}";               break; // positive B meson
				case -521:fParticleNameLaTeX = "#text{B}^{-}";               break; // positive B meson
				case 523: fParticleNameLaTeX = "#text{B}^{*+}";              break; // positive B* meson
				case -523:fParticleNameLaTeX = "#text{B}^{*-}";              break; // negative B* meson
				case 531: fParticleNameLaTeX = "#text{B}_{#text{s}}^{0}";  break; // neutral B strange meson
				case 533: fParticleNameLaTeX = "#text{B}_{#text{s}}^{*0}"; break; // neutral B* strange meson
				case 541: fParticleNameLaTeX = "#text{B}_{#c}^{+}";          break; // positive B charmed meson
				case -541:fParticleNameLaTeX = "#text{B}_{#c}^{-}";          break; // positive B charmed meson
				case 543: fParticleNameLaTeX = "#text{B}_{#c}^{*+}";         break; // positive B* charmed meson
				case -543:fParticleNameLaTeX = "#text{B}_{#c}^{*-}";         break; // negative B* charmed meson
				...
				case 443: fParticleNameLaTeX = "#text{J}/#psi ";             break; // J/psi meson
				case 551: fParticleNameLaTeX = "#eta_{#b}";                    break; // eta beauty meson
				case 553: fParticleNameLaTeX = "#Upsilon";                     break; // upsilon meson
				case 130: fParticleNameLaTeX = "#text{K}_{#text{L}}^{0}";  break; // neutral K_L meson
				case 310: fParticleNameLaTeX = "#text{K}_{#text{S}}^{0}";  break; // neutral K_S meson
			// * Baryons
				case 1114: fParticleNameLaTeX = "#Delta^{-}";        break; // Delta-
				case 2112: fParticleNameLaTeX = "#text{n}";        break; // neutron
				case 2114: fParticleNameLaTeX = "#Delta^{0}";        break; // Delta0
				case 2212: fParticleNameLaTeX = "#text{p}";        break; // proton
